...
<div class="section">
	<form method="POST" action="{!! route('post-answer'); !!}">
		...
		<p><b><i>Read the text and answer the multiple-choice question by selecting the correct response. Only one response is correct. </i></b></p>
		...
		<div class="row">
			...
			<div class="col s12">
				@foreach($questions[$page_num-1]->choices as $choice)
					<p>
						<label>
							<input class="with-gap" name="answer" type="radio" value="{!! $choice->id !!}" />
